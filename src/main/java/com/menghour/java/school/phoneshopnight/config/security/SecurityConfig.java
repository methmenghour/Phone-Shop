...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Bean //401 Unauthorized
	@Override
	protected UserDetailsService userDetailsService() {
		//User user1 =new User("dara","dara123",Collections.emptyList()); //401 Unauthorized Cuz Password
	...
	/*
		User user1 =new User("dara", passwordEncoder.encode("dara123"), Collections.emptyList());
		 ...
		 UserDetails user2 = User.builder()
				.username("thida")
				//.password("thida123") //401 Unauthorized Cuz Password
